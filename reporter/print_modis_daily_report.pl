...
#
# Subroutine prints a report of the number of MODIS files processed on a particular day.
#
...
sub print_daily_report_from_processed_file_registry
{
    ...
    my $i_unique_id   = $_[0];
    my $i_instrument  = $_[1];  # "MODIS_A" or "MODIS_T"
    ...
    if ($i_data_type eq "QUICKLOOK" || $i_data_type eq "REFINED") {
        ...
        print "print_modis_daily_report: Unrecognized processing type.  No need to continue\n";
        print "print_modis_daily_report: i_data_type = [$i_data_type]\n";
        return ($r_num_files_from_registry);
    }
    # print "L2P REGISTRY: $g_L2P_registry\n";
...
#print "system_command_string = [$system_command_string]\n";
  ...
  if ($num_files_processed > 0) {
      ...
      print "Software: Perl module print_modis_daily_report.pl\n";
...
{ 
    ...
    print "\n";
    print " -i instrument : MODIS_A or MODIS_T\n";
